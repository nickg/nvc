...
START_TEST(test_issue1353)
{
   ...
   tree_t c = tree_stmt(tree_stmt(a, 0), 0);
   fail_unless(folded_i(tree_name(tree_assoc(tree_stmt(c, 0), 0)), 0));
   fail_unless(folded_i(tree_name(tree_assoc(tree_stmt(c, 0), 1)), 1));
   tree_t r1 = tree_range(tree_assoc(tree_stmt(c, 1), 0), 0);
   fail_unless(folded_i(tree_left(r1), 2));
   fail_unless(folded_i(tree_right(r1), 3));
   tree_t r2 = tree_range(tree_assoc(tree_stmt(c, 2), 0), 0);
