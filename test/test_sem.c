...
START_TEST(test_gentype)
{
   ...
   const error_t expect[] = {
      ...
      { 70, "type of actual universal_integer does not match type T of " },
      ...
      { 88, "universal_integer does not match type T of formal generic INIT" },
      { 87, "no visible subprogram \"=\" matches signature [T, T return B" },
      { 87, "no visible subprogram \"/=\" matches signature [T, T return B" },
      { 91, "invalid use of label U12" },
      { 91, "universal_integer does not match type T of formal generic INIT" },
