...
START_TEST(test_attr)
{
   ...
   const error_t expect[] = {
      ...
      { 326, "cannot read output port X" },
      { 327, "cannot read output port X" },
      { 328, "cannot read output port X" },
...
START_TEST(test_issue1279)
{
   input_from_file(TESTDIR "/sem/issue1279.vhd");
...
START_TEST(test_issue1329)
{
   input_from_file(TESTDIR "/sem/issue1329.vhd");
...
START_TEST(test_issue1594)
{
   set_standard(STD_19);

   input_from_file(TESTDIR "/sem/issue1594.vhd");
...
Suite *get_sem_tests(void)
{
   ...
   tcase_add_test(tc_core, test_issue1594);
