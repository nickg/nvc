...
const char *jit_exit_name(jit_exit_t exit)
{
   static const char *names[] = {
      ...
      "RELEASE", "PUSH_SCOPE", "POP_SCOPE", "DRIVING", "DRIVING_VALUE",
      "COVER_TOGGLE", "COVER_STATE", "PROCESS_INIT", "CLEAR_EVENT",
      "ENTER_STATE", "REFLECT_VALUE", "REFLECT_SUBTYPE", "FUNCTION_TRIGGER",
      "ADD_TRIGGER", "TRANSFER_SIGNAL", "BIND_FOREIGN", "OR_TRIGGER",
