...
static psl_node_t p_psl_property_declaration(void)
{
...
static psl_node_t p_psl_sequence_declaration(void)
{
...
static tree_t p_psl_declaration(void)
{
   ...
   switch (tok) {
   case tPROPERTY:
      p = p_psl_property_declaration();
      break;
   case tSEQUENCE:
      p = p_psl_sequence_declaration();
      break;
   case tDEFAULT:
