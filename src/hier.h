...
// scope_tree hash on the synthetic root; children are reachable
// either by walking parent links upward or, given a parent, by
// probing `ident_prefix(parent->dotted, label, '.')` in the hash.
