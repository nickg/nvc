...
// scope_tree hash on the synthetic root; children are reachable by
// walking parent links upward, or — given a parent and a known child
// label — by probing `ident_prefix(parent->dotted, label, '.')` in
// the hash.
