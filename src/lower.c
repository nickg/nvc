...
static void lower_instantiated_package(lower_unit_t *lu, object_t *obj)
{
   ...
   lu->cscope = cover_create_unit(lu->cover, lu->name,
                                  lu->parent->cscope,
                                  decl, pack, NULL);
...
static void lower_inertial_actual_process(lower_unit_t *lu, object_t *obj)
{
   ...
   lu->cscope = cover_create_unit(lu->cover, lu->name, lu->parent->cscope,
                             ...
                             tree_t block)
{
   ...
   if (cover != NULL) {
      if (parent == NULL)
         lu->cscope = cover_create_unit(cover, name, NULL, block, unit, NULL);
         ...
         lu->cscope = cover_create_unit(cover, name, parent->parent->cscope,
                                        parent->container, unit, NULL);
      }
      else
         lu->cscope = cover_create_unit(cover, name, parent->cscope,
                                        block, unit, NULL);
